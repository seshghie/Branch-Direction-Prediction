...
void print_branch_stats()
{
    for (uint32_t i=0; i<NUM_CPUS; i++) {
        ...
        cout << "Branch misprediction for individual branch types" << endl;
        cout << "BRANCH_DIRECT_JUMP: " << ooo_cpu[i].branch_type_misses[1] << " " << (100.0 * ooo_cpu[i].branch_type_misses[1])/(ooo_cpu[i].total_branch_types[1]) << "%" << endl;
        cout << "BRANCH_INDIRECT: " << ooo_cpu[i].branch_type_misses[2] << " " << (100.0 * ooo_cpu[i].branch_type_misses[2])/(ooo_cpu[i].total_branch_types[2]) << "%" << endl;
        cout << "BRANCH_CONDITIONAL: " << ooo_cpu[i].branch_type_misses[3] << " " << (100.0 * ooo_cpu[i].branch_type_misses[3])/(ooo_cpu[i].total_branch_types[3]) << "%" << endl;
        cout << "BRANCH_DIRECT_CALL: " << ooo_cpu[i].branch_type_misses[4] << " " << (100.0 * ooo_cpu[i].branch_type_misses[4])/(ooo_cpu[i].total_branch_types[4]) << "%" << endl;
        cout << "BRANCH_INDIRECT_CALL: " << ooo_cpu[i].branch_type_misses[5] << " " << (100.0 * ooo_cpu[i].branch_type_misses[5])/(ooo_cpu[i].total_branch_types[5]) << "%" << endl;
        cout << "BRANCH_RETURN: " << ooo_cpu[i].branch_type_misses[6] << " " << (100.0 * ooo_cpu[i].branch_type_misses[6])/(ooo_cpu[i].total_branch_types[6]) << "%" << endl;
        cout << "BRANCH_OTHER: " << ooo_cpu[i].branch_type_misses[7] << " " << (100.0 * ooo_cpu[i].total_branch_types[7])/(ooo_cpu[i].total_branch_types[7]) << "%" << endl << endl;
